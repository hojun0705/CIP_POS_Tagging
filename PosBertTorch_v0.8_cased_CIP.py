...
for epoch in range(epochs):
    ...
    model.save_pretrained("/home/hojun/Python/Models/NLP/BERT/NER/code/POS_NER_POOMSA_TAGGING/CheckPoints/model_pretrained_10epoch")
    with open("/home/hojun/Python/Models/NLP/BERT/NER/code/POS_NER_POOMSA_TAGGING/CheckPoints/pos_cased_CIP_10epoch.txt", "wb") as fp:   #Pickling
